...
from _2020.day_11_seating_system import parse, part1, part2
from aoc.io import open_file


def data(name: str):
    with open_file(2020, 11, name) as file:
...
def test_input1():
    input = data("input")
    assert part1(input) == 2310


@pytest.mark.parametrize("n, expected", [(0, 26)])
