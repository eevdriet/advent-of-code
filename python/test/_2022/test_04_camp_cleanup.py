...
from _2022.day_04_camp_cleanup import parse, part1, part2
from aoc.io import open_file


def data(name: str):
    with open_file(2022, 4, name) as file:
...
def test_input1():
    input = data("input")
    assert part1(input) == 571


@pytest.mark.parametrize("n, expected", [(0, 4)])
